-- Fix Database Views and Functions
-- This script updates all database objects to use the new entity_staff table

-- 1. Drop the old employees_with_supervisors view
DROP VIEW IF EXISTS employees_with_supervisors;

-- 2. Create the new entity_staff_with_supervisors view
...
-- 4. Update get_full_reporting_chain function
...
-- 5. Update get_supervisor_chain function
...
-- 6. Update get_organizational_chart function
...
-- 7. Update validate_supervisor_assignment function
...
-- 8. Update the trigger to use the new function
...
SELECT 'Database functions and views updated successfully!' as status; 